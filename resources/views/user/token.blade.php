        ...
        <form action="javascript:void(0)" method="post" class="token-purchase">
            ...
            <div class="pay-buttons">
                <div class="pay-buttons pt-0">
                    <a data-type="offline" data-whitelisted="{{!$stage->vip_only || is_user_whitelisted()}}" href="#payment-modal" class="btn btn-primary btn-between payment-btn disabled token-payment-btn offline_payment">{{__('Make Payment')}}&nbsp;<i class="ti ti-wallet"></i></a>
                </div>
                <div class="pay-notes">
...
<div class="aside sidebar-right col-lg-4">
    ...
    @endif
    @if($stage->vip_only && !is_user_whitelisted())
    <div class="d-none d-lg-block">
        {!! UserPanel::add_whitelist_alert() !!}
    </div>
    @endif
