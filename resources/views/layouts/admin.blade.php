            ...
            <div class="container">
                <div class="navbar-innr">
                    <ul class="navbar-menu" id="main-nav">
                        ...
                        @endif
                        <li{!! ((is_page('whitelist'))? ' class="active"' : '') !!}>
                            <a href="{{ route('admin.whitelist') }}"><em class="ikon ikon-whitelist"></em> Whitelist</a>
                        </li>
                        @if(gup('stage'))
...
@php
    ...
    $route_urls = [
        ...
        'whitelist_delete_url' => 'admin.ajax.whitelist.delete'
    ];
