...
Route::prefix('admin')->middleware(['auth', 'admin', 'verify_user', 'g2fa', 'ico'])->name('admin.')->group(function () {
    ...
    Route::get('/check-transaction/online', 'Admin\TransactionController@checkStatus')->middleware('ico')->name('transactions.check');
    ...
    Route::get('/whitelist', 'Admin\WhitelistController@index')->middleware('ico')->name('whitelist');
    Route::post('/whitelist/view', 'Admin\WhitelistController@show')->name('whitelist.view');
    ...
    Route::name('ajax.')->prefix('ajax')->middleware(['ico'])->group(function () {
        ...
        Route::post('/settings/email/test', 'Admin\EmailSettingController@sendTestEmail')->middleware(['super_admin', 'demo_user'])->name('settings.email.test');
        ...
        Route::post('/whitelist/update/all', 'Admin\WhitelistController@update')->name('whitelist.delete')->middleware('demo_user');
        Route::post('/whitelist/insert', 'Admin\WhitelistController@store')->middleware('demo_user')->name('whitelist.add');
        Route::post('/users/delete', 'Admin\WhitelistController@delete')->name('whitelist.delete')->middleware('demo_user');
    });
